...
--
-- Host: localhost
-- Generation Time: Feb 19, 2026 at 05:25 PM
...
INSERT INTO `school_settings` (`setting_id`, `setting_key`, `setting_value`, `description`, `updated_by`, `updated_at`) VALUES
(1, 'school_name', NULL, 'Official name of the school', NULL, '2026-02-19 15:43:16'),
(2, 'school_id', NULL, 'DepEd School ID (printed on enrollment form)', NULL, '2026-02-19 15:43:16'),
(3, 'school_address', NULL, 'Complete school address', NULL, '2026-02-19 15:43:16'),
(4, 'division', NULL, 'DepEd Division', NULL, '2026-02-19 15:43:16'),
(5, 'district', NULL, 'DepEd District', NULL, '2026-02-19 15:43:16'),
(6, 'region', NULL, 'DepEd Region', NULL, '2026-02-19 15:43:16'),
(7, 'principal_name', NULL, 'Name of the School Principal', NULL, '2026-02-19 15:43:16'),
(8, 'school_year_label', NULL, 'Display label e.g. 2025-2026', NULL, '2026-02-19 15:43:16');
...
--
ALTER TABLE `grading_period_statuses`
  MODIFY `grading_period_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
